<template>
  <ContentWrap>
    ...
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="汇报人姓名" prop="userNickName" label-width="100">
        <el-input
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['hk:user-report:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['hk:user-report:export']"
        >
...
const getList = async () => {
  loading.value = true
  try {
    const data = await UserReportApi.getUserReportPage(queryParams)
...
const handleDelete = async (id: number) => {
  try {
    ...
    // 发起删除
    await UserReportApi.deleteUserReport(id)
